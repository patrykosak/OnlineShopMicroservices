...
public class OrderService {
    ...
    public void placeOrder(OrderRequest orderRequest) {
        ...
        InventoryResponse[] inventoryResponsesArray = webClient.get()
                .uri("https://localhost:8082/api/v1/inventories", uriBuilder -> uriBuilder.queryParam("skuCode", skuCodes).build())
                .retrieve()
        ...
        if(allProductsInStock){
            ...
            throw  new IllegalArgumentException("Product is not in stock, please try againg later");
        }
    }
